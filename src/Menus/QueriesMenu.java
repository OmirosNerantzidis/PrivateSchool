...
import static Queries.AssignmentsPerStudent.assignmentsPerStudent;
import static Queries.CourseListPrint.courseListPrint;
import static Queries.DueSubmissions.dueSubmissions;
...
public class QueriesMenu {
    ...
    public static void queriesMenu() {
        ...
        do {
            ...
            System.out.println("8 - List of Assignments of a Student");
            System.out.println("9 - List of Students that belong to more than 1 courses");
            System.out.println("10 - List of Students with Assignments due to a specific calendar week");
            System.out.println("");
            System.out.println("0 - Back to Main Menu");
            System.out.println("");
            System.out.print("Please Select (0-10): ");

            queriesMenuInputInt = intRangeChecker(0, 10, queriesMenuInput);

        } while (queriesMenuInputInt < 0 || queriesMenuInputInt > 10);
