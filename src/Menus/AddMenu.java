...
public class AddMenu {
    ...
    public static void addMenu() {
        ...
        while (addMenuInputInt < 0 || addMenuInputInt > 8) {
            ...
            System.out.println("7 - Edit Oral Mark to a Student's Assignment");
            System.out.println("8 - Edit Total Mark to a Student's Assignment");
            System.out.println("");
            System.out.println("0 - Back to Main Menu");
            System.out.println("");
            System.out.print("Please Select (0-8): ");

            addMenuInputInt = intRangeChecker(0, 8, addMenuInput);
